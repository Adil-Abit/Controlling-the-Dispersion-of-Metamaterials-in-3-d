function x_cross_f_Linear = MatAssem_Eig_Left_Cross_Product_Linear_Form_With_P1Basis()
...
Quadrature_Order = 3;
G1 = GeoElement(Omega);
x_cross_f_Linear = Matrices(Quadrature_Order,G1);
x_cross_f_Linear = x_cross_f_Linear.Append_Matrix(first_component);
x_cross_f_Linear = x_cross_f_Linear.Append_Matrix(second_component);
x_cross_f_Linear = x_cross_f_Linear.Append_Matrix(third_component);
end